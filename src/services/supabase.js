...
export async function signUp(email,password,fullName=''){return supabase.auth.signUp({email,password,options:{data:{full_name:fullName},emailRedirectTo:location.origin}})}
